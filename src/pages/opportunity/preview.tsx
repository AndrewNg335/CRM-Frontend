...
const EditOpportunityModal = ({ 
  ...
  return (
    <ProfessionalModal
      {...modalProps}
      title="Chỉnh sửa cơ hội bán hàng"
        ...
        <Row gutter={[24, 16]}>
          ...
          <Col xs={24} md={8}>
            <ProfessionalFormItem
              ...
              name="probability"
              icon={<PercentageOutlined className="text-orange-500" />}
            >
              <InputNumber 
                min={0} 
                max={100} 
        ...
        <Row gutter={[24, 16]}>
          ...
          <Col xs={24} md={12}>
            <ProfessionalFormItem
              ...
              name="nextStep"
              icon={<FlagOutlined className="text-indigo-500" />}
            >
...
export const OpportunityPreview = () => {
  ...
  // Fetch owner (responsible user) details if ownerId exists
  ...
  return (
    <div className="page-container">
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col xs={24} lg={16}>
              ...
              >
                {stageList.map((stage, i) => (
                  <Step
                    ...
                    status={getStepStatus(i, opportunity.opportunityStage)}
                    icon={
                      <div 
          ...
          <Card className="professional-card mb-6" title={
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} sm={12}>
                <div className="mb-4">
                  <Text strong className="text-gray-600">Nguồn khách hàng:</Text>
                  <div className="mt-1">
                    <Tag color="blue">{opportunity.leadSource}</Tag>
                  </div>
                </div>
              </Col>
            </Row>
          ...
          <Card className="professional-card" title={
            ...
            <Timeline>
              {opportunity.closeDate && (
                <Timeline.Item 
                  dot={<TrophyOutlined style={{ color: stageColor }} />}
                  color={stageColor}
                >
                  <div>
        ...
        {/* Right Column - Statistics and Related Info */}
        <Col xs={24} lg={8}>
          {/* Key Statistics */}
          <Card className="professional-card mb-6" title={
            <div className="flex items-center space-x-2">
