        ...
        <Card className="mb-4" bodyStyle={{ padding: '16px 24px' }}>
          <Form {...searchFormProps} layout="inline" style={{ width: '100%' }}>
            <Form.Item name="title" style={{ marginBottom: 0, width: '100%' }}>
              <Input.Search
                placeholder="Tìm kiếm form theo tiêu đề hoặc mô tả..."
                size="large"
      ...
      <Row gutter={[16, 16]} className="mb-6">
        ...
        <Col xs={24} sm={6}>
          <FilterableStatsCard
            ...
            value={getStatsData().totalSubmissions}
            color="#8b5cf6"
            isActive={activeFilter === 'submissions'}
            onClick={() => handleFilterClick('submissions')}
          />
        </Col>
      </Row>
      ...
      <Card className="shadow-lg border-0 rounded-lg overflow-hidden">
        <Table
          ...
          pagination={{
            ...
            showTotal: (total, range) => 
              `${range[0]}-${range[1]} của ${total} form đăng ký`,
        ...
        >
          ...
          <Table.Column<OptinForm>
            ...
            width={120}
            sorter={(a, b) => ((a as any).submissionCount || 0) - ((b as any).submissionCount || 0)}
          />
