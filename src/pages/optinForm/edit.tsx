                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <Typography.Text 
                      ...
                      onClick={() => window.open(`/optin-forms/preview/${currentData._id}`, '_blank')}
                    >
                      Xem trước
                    </Typography.Text>
                  </div>
      ...
      <Row gutter={[32, 32]}>
              ...
              >
                <Row gutter={[24, 24]}>
                  ...
                  <Col span={24}>
                    ...
                    >
                      <Input.TextArea 
                        placeholder="Nhập mô tả chi tiết cho form đăng ký" 
                        rows={4}
                        className="professional-input"
                      />
                    </Form.Item>
                  ...
                  <Col span={24}>
                    ...
                    >
                      <Select 
                        {...campaignSelectProps} 
                        placeholder="Chọn chiến dịch mà lead sẽ thuộc về"
                  ...
                  <Col span={24}>
                    ...
                    >
                      <Select 
                        {...userSelectProps} 
                        placeholder="Chọn người sẽ phụ trách lead sau khi đăng ký"
                        className="professional-select"
                        size="large"
                      />
                    </Form.Item>
        ...
        <Col xs={24} xl={10}>
          <Card 
            ...
            className="shadow-lg border-0 rounded-xl sticky top-6"
            bodyStyle={{ padding: '32px' }}
          >
              ...
              <div>
                ...
                <div className="relative">
                  <Input.TextArea
                    ...
                    readOnly
                    value={embedCode}
                    className="!font-mono !text-sm !bg-gray-50 !border-gray-200 !rounded-lg"
                    style={{ 
                      resize: 'none',
