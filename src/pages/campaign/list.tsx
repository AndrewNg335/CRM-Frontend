...
export const CampaignList = ({ children }: React.PropsWithChildren) => {
  ...
  const { tableProps, filters, searchFormProps } = useTable<Campaign, HttpError, { name?: string } | any>({
    resource: "campaigns",
      ...
      <Row gutter={[16, 16]} className="mb-6">
        ...
        <Col xs={24} sm={6}>
          <FilterableStatsCard
            ...
            value={getStatsData().totalLeads}
            color="#8b5cf6"
            isActive={activeFilter === 'leads'}
        ...
        <Col xs={24} sm={6}>
          <FilterableStatsCard
            title="Tổng cơ hội"
            value={getStatsData().totalOpportunities}
            color="#f59e0b"
      ...
      <Card className="shadow-lg border-0 rounded-lg overflow-hidden">
        ...
        >
          ...
          <Table.Column<Campaign>
            ...
            width={100}
            sorter={(a, b) => (a.opportunityCount || 0) - (b.opportunityCount || 0)}
          />
          ...
          <Table.Column<Campaign>
            ...
            width={150}
            sorter={(a, b) => 
              calculateConversionRate(a.leadCount || 0, a.opportunityCount || 0) - 
              ...
              <Space size="small">
                <Tooltip title="Xem chi tiết">
                  <Button
                    size="small"
                    icon={<EyeOutlined />}
                    onClick={() => go({ to: `/campaigns/show/${value}` })}
