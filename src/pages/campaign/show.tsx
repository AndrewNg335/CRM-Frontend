...
export const CampaignShow = () => {
  ...
  // Get users list to find responsible user name
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <Space>
            <Button
              type="primary"
              icon={<EditOutlined />}
              onClick={() => go({ to: `/campaigns/edit/${campaign._id}` })}
          ...
          <Card className="professional-card mb-6" title={
            ...
            <Row gutter={[16, 16]}>
              <Col span={24}>
                <Statistic
                  title="Ngân sách"
                  value={campaign.campaignBudgetCost || 0}
              ...
              <Col span={24}>
                <Statistic
                  ...
                  value={campaign.campaignExpectedRevenue || 0}
                  formatter={(v) => formatCurrency(Number(v))}
              ...
              <Col span={24}>
                <Statistic
                  title="Cơ hội"
                  value={campaign.opportunityCount || 0}
