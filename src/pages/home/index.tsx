          ...
          <Col xs={24} sm={24} xl={8}>
            <div className="professional-card">
              <DashboardTotalCountCard
                ...
                isLoading={isLoading}
                totalCount={opportunitiesData?.total || 0}
          ...
          <Col xs={24} sm={24} xl={8}>
            <div className="professional-card">
              <DashboardTotalCountCard
                resource="deals"
                isLoading={isLoading}
                totalCount={opportunitiesData?.data?.filter((opportunity: any) => opportunity.opportunityStage === OpportunityStage.CLOSED_WON || opportunity.opportunityStage === OpportunityStage.CLOSED_LOST).length || 0}
