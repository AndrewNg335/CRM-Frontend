...
export const UserEditModal: React.FC<UserEditModalProps> = ({ modalProps, formProps, roleSelectProps, }) => {
    return (<ProfessionalModal {...modalProps} title="Chỉnh sửa người dùng" icon={<UserOutlined className="text-blue-600"/>} width={800} destroyOnClose>
