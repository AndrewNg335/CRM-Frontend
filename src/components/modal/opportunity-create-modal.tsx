      ...
      <Form {...formProps} layout="vertical" className="space-y-4" initialValues={initialValues}>
        <Row gutter={[24, 16]}>
          {isAdmin ? (<Col xs={24} md={12}>
            ...
            </Col>) : (<Form.Item name="ownerId" hidden>
              <Input />
            </Form.Item>)}
          <Col xs={24} md={12}>
        ...
        <Row gutter={[24, 16]}>
          ...
          <Col xs={24} md={12}>
            <ProfessionalFormItem label="Chiến dịch" name="campaignId" icon={<LinkOutlined className="text-orange-500"/>}>
              <Select 
                {...campaignSelectProps} 
        ...
        <ProfessionalFormItem label="Ghi chú" name="notes" icon={<TagOutlined className="text-gray-500"/>}>
          <Input.TextArea rows={3} placeholder="Nhập ghi chú" showCount maxLength={500}/>
        </ProfessionalFormItem>
