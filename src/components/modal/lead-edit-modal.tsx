...
export const LeadEditModal: React.FC<LeadEditModalProps> = ({ modalProps, formProps, ownerSelectProps, isAdmin = false, }) => {
    return (<ProfessionalModal {...modalProps} okText="Lưu" cancelText="Hủy" title="Chỉnh sửa khách hàng tiềm năng" icon={<UserOutlined className="text-blue-600"/>} width={800} destroyOnClose>
