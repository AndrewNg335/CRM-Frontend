import { CalendarOutlined, DollarOutlined, RiseOutlined, TrophyOutlined, EyeOutlined } from "@ant-design/icons";
...
export const OpportunityCard: React.FC<OpportunityCardProps> = ({ opportunity, onDelete }) => {
    const go = useGo();
    const stageStyle = getStageColor(opportunity.opportunityStage);
    return (<Card size="small" className="opportunity-card" style={{
            marginBottom: 12,
            borderRadius: 12,
            border: 'none',
          ...
          <Space align="start" style={{ width: '100%' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ marginBottom: 8 }}>
                ...
                <Tag color={stageStyle.color} style={{
            fontSize: 11,
            borderRadius: 6,
            margin: 0
            ...
            color: '#1f2937'
              ...
              {opportunity.probability && (<div style={{ marginBottom: 8 }}>
                  <Text style={{ fontSize: 12, color: '#6b7280' }}>Xác suất thành công:</Text>
                  <Progress percent={opportunity.probability} size="small" strokeColor={stageStyle.color} style={{ marginTop: 4 }} showInfo={false}/>
        ...
        <div style={{ marginLeft: 12 }}>
          <Space size="small">
            ...
            <Tooltip title="Xóa cơ hội">
              <DeleteButton resource="opportunities" recordItemId={opportunity._id} size="small" hideText danger onSuccess={() => onDelete(opportunity._id)} style={{
            opacity: 0.7,
            transition: 'opacity 0.2s ease'
        }}/>
            </Tooltip>
