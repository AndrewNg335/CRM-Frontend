...
const CurrentUser = () => {
  ...
  const content = (
    <div className="professional-card p-0 relative overflow-hidden">
      <div className="relative z-10">
        ...
        <div className="p-2">
          <Button
            className="professional-menu-button w-full mb-2"
          ...
          <Button
            className="professional-menu-button w-full"
            icon={<LogoutOutlined />}
            type="text"
            block
          >
  ...
  return (
    <>
        ...
        content={content}
        overlayClassName="professional-popover"
        >
