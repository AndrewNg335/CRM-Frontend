...
export const DashboardTotalCountCard = ({
  ...
  return (
    <Card
      ...
      style={{ height: "96px", padding: 0, cursor: onClick ? "pointer" : undefined }}
      bodyStyle={{
...
const variants: {
  ...
  leads: {
    ...
    icon: (
      <IconWrapper color="rgba(59, 130, 246, 0.2)">
        <ShopOutlined
          className="md"
          style={{
            color: "#3b82f6",
  ...
  opportunities: {
    ...
    icon: (
      <IconWrapper color="rgba(16, 185, 129, 0.2)">
        <TeamOutlined
          className="md"
          style={{
            color: "#10b981",
  ...
  deals: {
    ...
    icon: (
      <IconWrapper color="rgba(245, 158, 11, 0.2)">
        <AuditOutlined
          className="md"
          style={{
            color: "#f59e0b",
